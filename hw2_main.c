...
{
	int date_day = 21, date_month=3, date_year=2021, dayno;
	printf("\n--------------------------------------------------------------------------\n");
...
{
	int start_day = 14, start_month=3, start_year=2019;
	int end_day = 29, end_month=6, end_year=2021;
	int numdays;
	printf("\n--------------------------------------------------------------------------\n");
...
void test_print_tabulated() {
	...
	printf("--------------------------------------------------------------------------\n");
	print_tabulated(1, 1.154, -1, 44499, 2.0, 2, 3, 3.1, -33, '*');
}
